     ...
     <div style={{display:"flex"}}>   
      ...
      Props.Moviegurudata.map((values,index)=>{
        return(
            ...
            <div onClick={ function (){click(values)}} style={{width: "10rem",height:"18rem",backgroundImage:`url(${values.img1})`,backgroundRepeat:"no-repeat",backgroundSize:"cover",borderRadius:"10px"}} >
